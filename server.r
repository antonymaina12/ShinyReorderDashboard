...
shinyServer(func = function(input, output, session) {
          ...
          loadData <- reactive({
                    ...
                    PurchasePrice = as.data.frame(read.csv("./supplier_cost_report.csv"))
...
# setwd("/media/taepark/Tae Park External Hard Drive/Projects/Projects/ReorderReport")
# df = read_excel("Example_file.xlsx", sheet = 1, skip = 4, skipEmptyCols = F)
# LEADTIME = 8
# CSL = 0.95
# time0 = mainData[1, 3]
